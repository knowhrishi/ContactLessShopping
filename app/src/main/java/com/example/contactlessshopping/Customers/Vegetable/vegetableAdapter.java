...
//    }
    ...
    public vegetableAdapter(FirestoreRecyclerOptions<Shopsclass> options, double dlat, double dlon, Context context) {

        super(options);
        this.dlat = dlat;
        this.dlon = dlon;
        this.context = (Vegetable_MainActivity) context;
    }
     ...
     * @param options
     */
    public vegetableAdapter(@NonNull FirestoreRecyclerOptions<Shopsclass> options) {
        super(options);
    }
